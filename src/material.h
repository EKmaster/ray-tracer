...
/*
Material system controlling scattering and emission.
- scatter(...) defines how rays bounce and attenuate.
- emitted(...) allows light sources to contribute radiance.
- Includes diffuse, metal, dielectric, emissive, and isotropic media models.
*/
...
class lambertian : public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation,
        ...
        // Cosine-weighted-ish diffuse bounce around surface normal.
...
class metal : public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation,
                 ray& scattered) const override {
        // Perfect reflection perturbed by fuzz radius.
...
class dielectric : public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation,
        ...
        // Total internal reflection or Schlick reflectance probability.
...
class isotropic : public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation,
                 ray& scattered) const override {
        // Uniform random direction for volumetric scattering events.
